  ...
  <div className="flex">
    <div className="ml-3">
      <p className="text-indigo-700">
        <strong className="text-indigo-700">Actualizacion: </strong> Si bien los
        algoritmos son una buena forma de practicar, recomiendo el siguiente
        articulo donde explico una mejor forma de{' '}
        <a
          href="https://matiasverdier.com/posts/como-ganar-experiencia-como-developer-sin-tener-trabajo"
          rel="noopener noreferrer"
          target="_blank"
        >
          ganar experiencia real aunque no tengas un trabajo
        </a>
      </p>
    </div>
  </div>
